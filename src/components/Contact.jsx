        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <p className="font-body text-white/50 text-sm md:text-lg leading-relaxed mb-8 md:mb-10 max-w-md">
              Need a website for your business? Looking for a fullstack developer for your team?
              I'm available for <span className="text-gold font-medium">freelance projects</span> and
              actively seeking <span className="text-gold font-medium">internship opportunities</span>.
