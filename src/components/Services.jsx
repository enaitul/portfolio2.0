...
import { FiGlobe, FiCode, FiTerminal, FiUsers } from 'react-icons/fi'
...
const services = [
  {
    ...
    description:
      'Building end-to-end web applications with React, Node.js, Express, and MongoDB. From responsive frontends to scalable APIs — the complete package.',
    link: '#portfolio',
  ...
  },
  {
    ...
    description:
      'Need a website for your business? I help local clients and startups build modern, responsive websites — from concept to deployment. Let\'s bring your vision to life.',
    link: '#contact',
    linkLabel: 'Hire Me',
  ...
  },
  {
    ...
    description:
      '200+ DSA problems solved across LeetCode, CodeStudio & GFG. Strong algorithmic thinking with C++ and Java for efficient, optimized solutions.',
