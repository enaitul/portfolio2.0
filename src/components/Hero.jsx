    ...
    >
      ...
      <div className="relative z-10 section-padding w-full pt-20 md:pt-24">
        <div className="max-w-4xl">
          ...
          >
            Fullstack developer & 2× hackathon winner. 200+ DSA problems solved.
            Building production-ready web apps and helping businesses grow through freelancing.
          </motion.p>
          ...
          >
            {['React', 'Node.js', 'Express', 'MongoDB', 'JavaScript', 'C++', 'Java', 'Python', 'Tailwind CSS', 'DSA'].map((tech, i) => (
              <motion.span
                key={tech}
